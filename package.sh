...
electron-packager . Phoenix --platform=win32 --arch=ia32 --asar --icon icons/icon.ico --out=dist --prune --version-string.ProductName="Phoenix" --version-string.CompanyName="artur9010"